...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Trainee',
            fields=[
                ('uniqueID', models.CharField(default='B139F', editable=False, max_length=50, primary_key=True, serialize=False, verbose_name='Unique ID')),
                ('purpose', models.CharField(choices=[('Computer', 'Computer'), ('Volunteer', 'Volunteer'), ('Academic', 'Academic'), ('Member', 'Member'), ('Tailoring', 'Tailoring'), ('English Speaking', 'English Speaking')], max_length=255, null=True, verbose_name='Purpose')),
