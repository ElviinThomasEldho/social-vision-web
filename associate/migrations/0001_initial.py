    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uniqueID', models.CharField(default='FCD04', editable=False, max_length=50, primary_key=True, serialize=False, verbose_name='Unique ID')),
                ...
                ('receipt1', models.ImageField(null=True, upload_to='', verbose_name='Receipt Photograph 1')),
                ('receipt2', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Receipt Photograph 2')),
        ...
        migrations.CreateModel(
            name='Revenue',
            fields=[
                ('uniqueID', models.CharField(default='FD211', editable=False, max_length=50, primary_key=True, serialize=False, verbose_name='Unique ID')),
                ('firstName', models.CharField(max_length=255, null=True, verbose_name='First Name')),
                ('lastName', models.CharField(max_length=255, null=True, verbose_name='Last Name')),
                ('mobileNumber', models.CharField(max_length=13, null=True, verbose_name='Mobile Number')),
                ('emailID', models.EmailField(max_length=254, null=True, verbose_name='Email Address')),
        ...
        migrations.CreateModel(
            name='Expense',
            fields=[
                ('uniqueID', models.CharField(default='6F721', editable=False, max_length=50, primary_key=True, serialize=False, verbose_name='Unique ID')),
        ...
        migrations.CreateModel(
            name='Associate',
            fields=[
                ('uniqueID', models.CharField(default='286B7', editable=False, max_length=50, primary_key=True, serialize=False, verbose_name='Unique ID')),
